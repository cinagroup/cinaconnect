/**
 * viem Adapter — wraps viem's Client and Transport for OnChainUX.
 *
...
/**
 * viem-backed chain adapter implementing the OnChainUX ChainAdapter interface.
 */
 ...
 * @param connector - Optional OnChainUX Connector.
